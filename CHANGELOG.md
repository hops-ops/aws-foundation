...
* chore(deps): update unbounded-tech/workflow-simple-release action to v2.1.3 (#83) (by @renovate[bot])

  Co-authored-by: renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>


See full diff: [v0.55.0...v0.55.1](https://github.com/hops-ops/aws-foundation/compare/v0.55.0...v0.55.1)
